export const exerciseTwentyOneHtml = () =>{
            ...
            <div class="card-body" >
                <form id="my-form">
                    <div class="input-group mt-3">
                        <span class="input-group-text">Digite o valor de X: </span>
                        <input
                        name="number1"
                        id="number_1"
                        type="number"
                    ...
                    <div class="mt-2 d-grid gap-2 d-md-flex justify-content-md-end" id="buttons" >
                        ...
                        <button type="button" class="btn btn-primary" value="ex21Enviar">Enviar</button>
                    </div>
                </form>
            </div>
